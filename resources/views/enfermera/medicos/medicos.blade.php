...
@section('content')
                ...
                if (medicos.length > 0) {
                    ...
                    medicosPaginados.forEach((m, index) => {
                        ...
                        const tipoClass = m.tipoMed === 'Interno'
                            ? 'bg-gradient-to-r from-pink-100 to-teal-100 text-emerald-800 border border-pink-200'
                            : m.tipoMed === 'Externo'
                        ...
                        const estadoClass = m.estado === 'Activo'
                            ? 'bg-gradient-to-r from-pink-100 to-green-100 text-emerald-800 border border-pink-300'
                        ...
                        const btnEstadoClass = m.estado === 'Activo'
                            ...
                            : 'text-pink-700 bg-gradient-to-r from-pink-50 to-teal-50 hover:from-pink-100 hover:to-teal-100 border-pink-200';

                        const btnEstadoIcon = m.estado === 'Activo' ? 'block' : 'check_circle';
                        const btnEstadoText = m.estado === 'Activo' ? 'Desactivar' : 'Activar';

                        const fila = `
                            <tr class="bg-white border-b hover:bg-gradient-to-r hover:from-pink-50 hover:to-teal-50 transition-all duration-200">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center shadow-md">
    ...
    <!-- Botón EDITAR -->
    <a href="/enfermera/medicos/editar/${m.codMed}"
        class="flex items-center gap-1 px-4 py-2 text-sm font-semibold
               text-pink-700 bg-pink-50 border border-pink-200 rounded-lg
               hover:bg-pink-100 transition shadow-sm"
        title="Editar">
        ...
        ${btnEstadoText}
            ...
            function renderPaginador(totalPaginas) {
                ...
                html += `
                    <div class="text-sm text-gray-700 font-medium">
                        Página <span class="font-bold text-pink-600">${paginaActual}</span> de <span class="font-bold">${totalPaginas}</span>
                    </div>
                `;
                ...
                html += `
                    <button onclick="cambiarPagina(${paginaActual - 1})"
                        ...
                        ${paginaActual === 1
                            ...
                            : 'bg-white text-pink-600 border border-pink-200 hover:bg-gradient-to-r hover:from-pink-50 hover:to-teal-50 shadow-sm hover:shadow-md'}">
                ...
                if (inicio > 1) {
                    html += `<button onclick="cambiarPagina(1)" class="px-3 py-2 text-sm font-bold rounded-lg bg-white text-gray-700 border border-gray-200 hover:bg-gradient-to-r hover:from-pink-50 hover:to-teal-50 hover:text-pink-600 hover:border-pink-200 transition-all duration-200 shadow-sm">1</button>`;
                    if (inicio > 2) {
                    ...
                    html += `
                        <button onclick="cambiarPagina(${i})"
                            ...
                            ${i === paginaActual
                                ...
                                : 'bg-white text-gray-700 border border-gray-200 hover:bg-gradient-to-r hover:from-pink-50 hover:to-teal-50 hover:text-pink-600 hover:border-pink-200'}">
                            ${i}
                        </button>
                    `;
                }
                ...
                if (fin < totalPaginas) {
                    ...
                    html += `<button onclick="cambiarPagina(${totalPaginas})" class="px-3 py-2 text-sm font-bold rounded-lg bg-white text-gray-700 border border-gray-200 hover:bg-gradient-to-r hover:from-pink-50 hover:to-teal-50 hover:text-pink-600 hover:border-pink-200 transition-all duration-200 shadow-sm">${totalPaginas}</button>`;
                }
            ...
            async function cambiarEstadoMedico(id, estadoActual) {
                ...
                if (estadoActual === 'Activo') {
                    ...
                    // Activar
                    iconoEstado.className = 'rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 p-4 shadow-lg';
                    ...
                    btnConfirmar.className = 'flex-1 inline-flex justify-center items-center px-5 py-3 text-sm font-bold text-white bg-gradient-to-r from-pink-500 to-rose-600 rounded-xl hover:from-pink-600 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105';
                ...
                const contenido = `
                    <div class="space-y-6">
                        <div class="flex items-center space-x-4">
                            <div class="h-20 w-20 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center shadow-lg">
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            <a href="/enfermera/medicos/editar/${medico.codMed}" class="inline-flex items-center px-5 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-pink-500 to-rose-600 rounded-xl hover:from-pink-600 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
            ...
            function mostrarAlerta(tipo, mensaje) {
                ...
                const colores = {
                    success: 'bg-gradient-to-r from-pink-50 to-teal-50 border-emerald-400 text-emerald-800',
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg border border-gray-200 p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl p-4 shadow-lg">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg border border-gray-200 p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 bg-gradient-to-br from-teal-500 to-pink-600 rounded-xl p-4 shadow-lg">
        ...
        <div class="bg-gradient-to-r from-white to-gray-50 rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                ...
                <a href="{{ route('enfermera.medicos.agregar') }}"
                    class="mt-4 md:mt-0 inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-600 text-white rounded-xl hover:from-pink-600 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl font-bold transform hover:scale-105">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        <span class="material-icons absolute left-3 top-3 text-pink-600">search</span>
                        <input type="text" id="busqueda" placeholder="Buscar por nombre o apellido..."
                            class="pl-11 w-full bg-white border-2 border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 p-3 transition-all shadow-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select id="filtroTipo"
                        class="w-full bg-white border-2 border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 p-3 transition-all shadow-sm font-medium">
            ...
            <div class="mt-4">
                <button onclick="limpiarFiltros()" class="inline-flex items-center text-sm text-pink-600 hover:text-pink-700 font-bold hover:underline">
        ...
        <div id="loader" class="flex justify-center items-center py-16">
            <div class="relative">
                ...
                <div class="animate-spin rounded-full h-16 w-16 border-4 border-pink-500 border-t-transparent absolute top-0 left-0"></div>
            </div>
        </div>
        ...
        <div id="no-data" class="hidden bg-white rounded-xl shadow-lg border border-gray-200 p-16">
            <div class="flex flex-col items-center justify-center">
                <div class="w-32 h-32 bg-gradient-to-br from-pink-100 to-teal-100 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                    <span class="material-icons text-pink-600" style="font-size: 80px;">medical_services</span>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden" id="tabla-container">
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gradient-to-r from-pink-500 to-rose-600 border-b-2 border-teal-700">
                        <tr>
