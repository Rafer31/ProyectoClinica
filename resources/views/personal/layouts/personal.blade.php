            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        ...
                        class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-200 transition-all">
                    ...
                    <a href="{{ route('personal.home') }}" class="flex ms-2 md:me-24 items-center group">
                        ...
                        <div class="ms-3">
                            <span
                                class="block text-xl font-bold text-gray-800 group-hover:text-emerald-600 transition-colors">Clínica
                                Santa Lucía</span>
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3 gap-3">
                        <div
                            class="flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border border-emerald-200">
                            <div class="flex flex-col items-end">
                                <span class="text-sm font-semibold text-gray-800">{{ Auth::user()->nomPer }}
                                    {{ Auth::user()->paternoPer }}</span>
                                <span class="text-xs text-emerald-700 font-medium">Personal Imagen</span>
                            </div>
                            <div
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('personal.home') }}"
                        class="sidebar-item flex items-center p-3 rounded-xl hover:bg-emerald-50 group {{ request()->routeIs('personal.home') ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg' : 'text-gray-700 hover:text-emerald-600' }}">
                        <span
                            class="material-icons {{ request()->routeIs('personal.home') ? 'text-white' : 'text-emerald-600' }}">dashboard</span>
                ...
                <li>
                    <button type="button"
                        class="sidebar-item flex items-center w-full p-3 rounded-xl hover:bg-emerald-50 group transition-colors {{ request()->routeIs('personal.cronogramas.*') ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg' : 'text-gray-700 hover:text-emerald-600' }}"
                        onclick="toggleSubmenu('cronogramas-submenu')">
                        <span
                            class="material-icons {{ request()->routeIs('personal.cronogramas.*') ? 'text-white' : 'text-emerald-600' }}">calendar_today</span>
                        <span class="ms-3 font-semibold flex-1 text-left">Cronogramas</span>
                        <span class="material-icons text-sm transition-transform"
                            id="cronogramas-submenu-icon">expand_more</span>
                    </button>

                    <!-- Submenú de Cronogramas -->
                    <ul class="ml-8 mt-2 space-y-2 {{ request()->routeIs('personal.cronogramas.*') ? '' : 'hidden' }}"
                        id="cronogramas-submenu">
                        <li>
                            <a href="{{ route('personal.cronogramas.cronogramas') }}"
                                class="sidebar-item flex items-center p-2 rounded-lg hover:bg-emerald-50 group {{ request()->routeIs('personal.cronogramas.cronogramas') && !request()->routeIs('personal.cronogramas.calendario') ? 'bg-emerald-100 text-emerald-700' : 'text-gray-700 hover:text-emerald-600' }}">
                                <span
                                    class="material-icons text-sm {{ request()->routeIs('personal.cronogramas.cronogramas') && !request()->routeIs('personal.cronogramas.calendario') ? 'text-emerald-600' : 'text-gray-500' }}">view_week</span>
                                <span class="ms-2 text-sm font-medium">Gestión de Cronogramas</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ route('personal.medicos.medicos') }}"
                        class="sidebar-item flex items-center p-3 rounded-xl hover:bg-emerald-50 group {{ request()->routeIs('personal.medicos.*') ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg' : 'text-gray-700 hover:text-emerald-600' }}">
                        <span
                            class="material-icons {{ request()->routeIs('personal.medicos.*') ? 'text-white' : 'text-emerald-600' }}">medical_services</span>
                ...
                <li>
                    <a href="{{ route('personal.pacientes.pacientes') }}"
                        class="sidebar-item flex items-center p-3 rounded-xl hover:bg-emerald-50 group {{ request()->routeIs('personal.pacientes.*') ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg' : 'text-gray-700 hover:text-emerald-600' }}">
                        <span
                            class="material-icons {{ request()->routeIs('personal.pacientes.*') ? 'text-white' : 'text-emerald-600' }}">people</span>
                ...
                <li>
                    <button type="button"
                        ...
                        <span
                            class="material-icons {{ request()->routeIs('personal.servicios.*') || request()->routeIs('personal.tipos-estudio.*') ? 'text-white' : 'text-emerald-600' }}">miscellaneous_services</span>
                        <span class="ms-3 font-semibold flex-1 text-left">Servicios</span>
                        <span class="material-icons text-sm transition-transform"
                            id="servicios-submenu-icon">expand_more</span>
                    </button>

                    <!-- Submenú de Servicios -->
                    <ul class="ml-8 mt-2 space-y-2 {{ request()->routeIs('personal.servicios.*') || request()->routeIs('personal.tipos-estudio.*') ? '' : 'hidden' }}"
                        ...
                        <li>
                            <a href="{{ route('personal.servicios.servicios') }}"
                                ...
                                <span
                                    class="material-icons text-sm {{ request()->routeIs('personal.servicios.servicios') ? 'text-emerald-600' : 'text-gray-500' }}">list_alt</span>
                        ...
                        <li>
                            <a href="{{ route('personal.servicios.atendidos') }}"
                                ...
                                <span
                                    class="material-icons text-sm {{ request()->routeIs('personal.servicios.atendidos') ? 'text-emerald-600' : 'text-gray-500' }}">check_circle</span>
                        ...
                        <li>
                            <a href="{{ route('personal.tipos-estudio.index') }}"
                                ...
                                <span
                                    class="material-icons text-sm {{ request()->routeIs('personal.tipos-estudio.*') ? 'text-emerald-600' : 'text-gray-500' }}">category</span>
                            ...
                            <li class="inline-flex items-center">
                                ...
                                @if(isset($breadcrumb['url']))
                                    <a href="{{ $breadcrumb['url'] }}"
                                        class="inline-flex items-center text-sm font-semibold text-gray-700 hover:text-emerald-600 transition-colors">
                                        {{ $breadcrumb['label'] }}
                                    </a>
                                @else
                ...
                <div class="fixed inset-0 flex items-center justify-center p-4">
                    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
                        ...
                        <div class="p-6 pb-0">
                            ...
                            <!-- Info usuario -->
                            <div
                                class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 mt-4 border border-gray-200">
