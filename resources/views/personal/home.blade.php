    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-center">
            ...
            <div class="relative">
                ...
                <!-- Menú Desplegable -->
                <div id="menu-reporte" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                    <div class="py-2">
...
function renderUltimosServicios(servicios) {
    ...
    tbody.innerHTML = servicios.map(servicio => {
        ...
        const fecha = new Date(servicio.fechaAten + 'T00:00:00').toLocaleDateString('es-ES');
