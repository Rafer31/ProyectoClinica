...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <p class="text-gray-600">{{ $esEdicion ? 'Modifica los datos del tipo de estudio' : 'Completa los pasos para crear un nuevo tipo de estudio' }}</p>
    </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex-1">
                <div class="flex items-center">
                    <div id="paso-1-indicator" class="paso-indicator active flex items-center justify-center w-10 h-10 rounded-full bg-purple-600 text-white font-bold">
                        1
                    </div>
                    <div class="flex-1 h-1 bg-gray-300 mx-2">
                        <div id="progreso-1" class="h-full bg-purple-600 transition-all duration-300" style="width: 0%"></div>
                    </div>
                </div>
            ...
            <div class="flex-1">
                <div class="flex items-center">
                    <div id="paso-2-indicator" class="paso-indicator flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 text-gray-600 font-bold">
                        2
                    </div>
                    <div class="flex-1 h-1 bg-gray-300 mx-2">
                        <div id="progreso-2" class="h-full bg-purple-600 transition-all duration-300" style="width: 0%"></div>
                    </div>
                </div>
            ...
            <div class="flex-1">
                <div class="flex items-center">
                    <div id="paso-3-indicator" class="paso-indicator flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 text-gray-600 font-bold">
                        3
                    </div>
                </div>
        ...
        <div id="paso-1" class="paso bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="siguientePaso(2)" class="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 flex items-center">
                        Siguiente
        ...
        <div id="paso-2" class="paso hidden bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    <button type="button" onclick="anteriorPaso(1)" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 flex items-center">
                        <span class="material-icons mr-2">arrow_back</span>
                        Anterior
                    </button>
                    <button type="button" onclick="siguientePaso(3)" class="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 flex items-center">
                        Siguiente
                        <span class="material-icons ml-2">arrow_forward</span>
                    </button>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <select id="select-requisito" class="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                            <option value="">-- Seleccione un requisito --</option>
                        </select>
                        <button type="button" onclick="agregarRequisitoSeleccionado()" class="px-4 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 flex items-center">
                            <span class="material-icons">add</span>
                        </button>
                    </div>
                    <p class="mt-1 text-sm text-gray-500">Seleccione los requisitos aplicables a este estudio</p>
                </div>
                ...
                <div>
                    ...
                    <div id="requisitos-agregados" class="space-y-2 min-h-[100px] border-2 border-dashed border-gray-300 rounded-lg p-4">
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-700"><strong>Observaciones:</strong> <span id="preview-observacion">-</span></p>
                        <p class="text-sm text-gray-700"><strong>Requisitos:</strong> <span id="preview-requisitos">-</span></p>
                    </div>
                </div>

                <div class="flex justify-between">
                    <button type="button" onclick="anteriorPaso(2)" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 flex items-center">
                        <span class="material-icons mr-2">arrow_back</span>
                        Anterior
                    </button>
